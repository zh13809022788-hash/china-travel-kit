...
**每天最多 push 1 篇新英文文章**，不可突破。

- 正常节奏：每 24 小时 1 篇英文 + 其翻译版本（翻译可滞后 1-2 天）
- 超出部分：写完后 commit 到本地，排队到次日再 push
- 周末可减量或暂停，但每天不超过 1 篇的规则不变

### 9.2 推送时间

默认推送窗口为 **北京时间 08:00**，对应 UTC 00:00，便于 Google 爬虫在活跃时段抓取。

- 翻译版本不与英文同批次推送——错开半天或隔天
- 非紧急修复类 commit 不在其他时段推送

### 9.3 翻译节奏

英文文章上线后，翻译版本在 1-3 天内分批推送：

- 第 1 天 08:00 → 1 篇英文
- 第 2 天 08:00 → 该英文的 ja/ko/zh-tw 翻译（3 个文件算 1 批）
- 第 3 天 08:00 → 下一篇英文（同时上一批翻译已收录）
- 以此类推

### 9.4 push 管理原则

- 写好的内容先 commit，不 push
- 到达发布时间窗口再统一 git push
- 紧急 Bug 修复不受此限（随时可推，需说明紧急原因）
