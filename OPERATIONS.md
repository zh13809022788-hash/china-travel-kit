...
**英文版 → 立即索引。翻译版 → noindex 待命，每周释放一种语言。**

新站爬虫预算有限，7种语言同时索引会分散爬虫。翻译版先存在于站点（用户可见、Google不索引），等英文站稳后再分批放出。

#### 每日发布流程

1. 08:00 前：Codex 写完英文 + 翻好7个语言版本
2. 08:00 整：push 英文 + 7个翻译版（翻译版自动 noindex）
3. 进入某语言的"释放周"时，从 `NOINDEX_LOCALES` 中移除该语言 → 重新 build 部署
...
|------|------|---------|-----|--------|
| — | 当前 | 仅英文 | 基础盘 | — |
| 第1周 | 7月28日 | ko 🇰🇷 | 韩国 | 700-780万 |
| 第2周 | 8月4日 | ru 🇷🇺 | 俄罗斯 | 520-600万 |
| 第3周 | 8月11日 | ja 🇯🇵 | 日本 | 160-210万 |
| 第3周 | 8月11日 | zh-tw 🇹🇼 | 台湾/香港 | ~200万 |
| 第4周 | 8月18日 | th/ms/vi 🇹🇭🇲🇾🇻🇳 | 东南亚 | 各300万+ |
| 第5周 | 8月25日 | fr/de/es 🇫🇷🇩🇪🇪🇸 | 法/德/西 | P2 |
