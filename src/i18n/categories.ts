...
export const CATEGORY_LABELS: Record<string, Record<LocaleCode, string>> = {
  ...
  essentials: { en: 'Essentials',  'zh-tw': '行前準備', ja: '旅行準備',   ko: '여행 준비', ru: 'Подготовка', fr: 'Préparatifs', de: 'Vorbereitung', es: 'Preparativos' ,  th: 'essentials',  vi: 'essentials',  ms: 'essentials'},
