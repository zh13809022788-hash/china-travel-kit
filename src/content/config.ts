...
const postsTh = defineCollection({ type: 'content', schema: z.object({ title: z.string(), description: z.string(), pubDate: z.coerce.date(), category: categorySchema, series: seriesSchema.optional(), tags: z.array(z.string()).default([]), featured: z.boolean().default(false), faqs: z.array(faqSchema).default([]), cover: z.string().optional(), coverAlt: z.string().optional(), }), });

const postsMs = defineCollection({ type: 'content', schema: z.object({ title: z.string(), description: z.string(), pubDate: z.coerce.date(), category: categorySchema, series: seriesSchema.optional(), tags: z.array(z.string()).default([]), featured: z.boolean().default(false), faqs: z.array(faqSchema).default([]), cover: z.string().optional(), coverAlt: z.string().optional(), }), });

const postsVi = defineCollection({ type: 'content', schema: z.object({ title: z.string(), description: z.string(), pubDate: z.coerce.date(), category: categorySchema, series: seriesSchema.optional(), tags: z.array(z.string()).default([]), featured: z.boolean().default(false), faqs: z.array(faqSchema).default([]), cover: z.string().optional(), coverAlt: z.string().optional(), }), });
