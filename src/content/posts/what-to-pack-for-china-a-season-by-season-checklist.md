...
faqs:
  - question: "Do I need to bring a VPN app to China?"
    answer: "Yes, download and set up a reputable VPN before you arrive, because most Western apps and sites like Google, Gmail, WhatsApp, and Instagram are blocked, and VPN provider websites are often unreachable once you are inside the country."
  - question: "What kind of power adapter works in China?"
    answer: "China uses 220V electricity with Type A, C, and I sockets, so bring a universal adapter; most phone and laptop chargers handle 220V automatically, but check the label on hair tools or other appliances before plugging them in."
  - question: "Can I use my foreign credit card in China?"
    answer: "You can use cards at big hotels and some airports, but daily life runs almost entirely on Alipay and WeChat Pay, so set up mobile payments and link an international card before you go, and carry a little cash as backup."
  - question: "Which medicines should I pack for China?"
    answer: "Bring a personal supply of any prescription drugs in original packaging with a doctor's note, plus basics like painkillers, anti-diarrheal tablets, motion sickness pills, and cold medicine, since foreign brands can be hard to find at local pharmacies."
