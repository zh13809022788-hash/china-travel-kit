...
faqs:
  - question: "Do tourists need a VPN in China?"
    answer: "Many tourists prepare one because some foreign websites and apps may not work normally on mainland China networks. But reliability varies, rules can change, and travelers should understand that VPN use in China is restricted. A travel eSIM or roaming plan may also route traffic differently from local Wi-Fi."
  - question: "Can I install a VPN after arriving in China?"
    answer: "Do not rely on that. VPN websites, app stores, payment pages, and support pages may be hard to access after arrival. If you choose to use one, research and install it before departure."
  - question: "What apps should I prepare even if I have a VPN?"
    answer: "Prepare local or China-friendly alternatives for maps, translation, payments, ride-hailing, train tickets, and messaging. A VPN is not a replacement for Alipay, WeChat, DiDi, offline translation, or saved hotel addresses."
  - question: "Is a VPN the same as an eSIM?"
    answer: "No. An eSIM gives your phone mobile data. A VPN routes traffic through another network path. Some travel eSIMs may provide easier access to foreign apps, but this depends on the provider and plan."
---
...
| Traveler type | VPN priority | Better backup |
| --- | --- | --- |
| Casual tourist using Alipay, maps, translation, and hotel apps | Medium | eSIM/roaming, offline hotel address, local apps |
| Traveler who needs Gmail, Google Drive, WhatsApp, Instagram, or work tools | High | Test access before departure and bring alternatives |
| Business traveler with company systems | High | Ask employer about approved remote access before travel |
| Family trip with multiple phones | Medium | Set up data and payment on more than one phone |
| Short layover | Low to medium | Download tickets, maps, and hotel info offline |
...
For travel survival, payment, transport, maps, and translation matter more than entertainment. Use the [app availability checker](/tools/app-availability-checker/) and the [internet access guide](/posts/internet-access-china-apps-that-work-2026/) before departure.
...
For deeper connectivity decisions, read [China eSIM vs roaming](/posts/china-esim-vs-roaming-2026-the-real-10-day-cost/) and compare options with the [eSIM plan comparator](/tools/esim-comparison/).
