...
faqs:
  - question: "Can I really use a foreign Visa or Mastercard with WeChat Pay?"
    answer: "Yes. Since late 2023 WeChat Pay has accepted international Visa, Mastercard, JCB, Discover, and Diners Club cards, and the process has been steadily smoothed out for tourists through 2024 and into 2026."
  - question: "Are there fees for paying with a foreign card on WeChat Pay?"
    answer: "Individual transactions of 200 RMB or less are generally free, while payments above 200 RMB carry roughly a 3% processing fee, on top of any foreign-transaction fee your own bank charges."
  - question: "What are the transaction limits for foreign cards?"
    answer: "Caps apply per transaction, per day, per month, and per year, and while the exact figures shift, tourists commonly see a single-payment ceiling in the low thousands of RMB and an annual limit equivalent to tens of thousands of US dollars."
  - question: "Do I need my passport to set this up?"
    answer: "Yes, real-name verification is required, so you will need to enter your passport details exactly as they appear on the document and match the name on your card."
  - question: "Why does my card keep getting rejected during binding?"
    answer: "The most common causes are a name mismatch between passport and card, a bank that blocks the verification charge as suspected fraud, or a debit card where credit cards work more reliably."
  - question: "Should I set up WeChat Pay before I arrive in China?"
    answer: "Ideally yes, because creating the account, verifying your identity, and binding your card over a stable connection before you land saves you from troubleshooting on arrival when you need to pay quickly."
---
...
1. **Open WeChat and go to the Wallet.** Tap **Me**, then **Services** (called Wallet in some versions), then **Wallet**.
2. **Complete real-name verification.** If you haven't already, WeChat will prompt you to verify your identity. Choose the option for foreign passport holders and enter your details precisely as printed on your passport.
3. **Add a bank card.** Inside the Wallet, tap **Bank Cards**, then **Add a Card** (or the plus icon).
4. **Enter your card number.** WeChat should detect that it's a foreign card and route you through the international flow rather than the Chinese one.
5. **Fill in the cardholder details.** Enter the name, expiry date, security code, and billing information. Match the name to your passport, not a nickname.
6. **Complete the verification charge.** The platform may place a tiny temporary authorization on your card to confirm it. This is where a nervous bank often blocks the transaction, so keep your phone nearby for a confirmation code.
7. **Confirm the card is bound.** Once it appears in your Bank Cards list, you're ready to pay.
