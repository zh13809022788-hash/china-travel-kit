...
faqs:
  - question: "Should foreigners use Alipay or WeChat Pay in China?"
    answer: "Most visitors should set up both. Alipay is often easier as a tourist-first payment app, while WeChat Pay is useful inside WeChat, restaurants, mini programs, and social situations. Having both gives you a fallback when one verification or merchant flow fails."
  - question: "Which app is easier to set up with a foreign card?"
    answer: "Alipay is usually the smoother starting point for tourists because the travel payment flow is more visible and the app has more visitor-facing tools. WeChat Pay also supports foreign cards, but some users find the wallet and verification steps less obvious."
  - question: "Do Alipay and WeChat Pay charge foreign card fees?"
    answer: "For small transactions, fees may be waived. For larger payments, a processing fee has commonly applied above a threshold such as 200 RMB. Your own card issuer may also charge foreign transaction fees."
  - question: "Can I travel with only one payment app?"
    answer: "You can, but it is not ideal. China is mobile-payment-first, and a single blocked card, failed SMS code, app outage, or merchant-specific flow can create friction. Set up both apps and carry small cash."
---
...
1. Install both apps before your trip.
2. Add a Visa or Mastercard to Alipay first.
3. Add the same card, or a different backup card, to WeChat Pay.
