...
faqs:
  - question: "Does Apple Pay work in China for tourists?"
    answer: "Apple Pay works at terminals that accept contactless international cards, such as large hotels, department stores, chain supermarkets, and metro gates in a handful of major cities, but it will not work at the many small vendors that only accept Alipay or WeChat Pay QR codes."
  - question: "Does Google Pay work in China?"
    answer: "Google Pay's tap-to-pay can technically work at the same contactless terminals that accept your linked Visa or Mastercard, but because Google services are blocked in China you should add your cards and confirm everything before you arrive, and you should not rely on it as your main payment method."
  - question: "What is the best payment method for tourists in China?"
    answer: "For most travelers the best setup is Alipay or WeChat Pay linked to a foreign Visa or Mastercard, since these QR-based apps are accepted almost everywhere, with Apple Pay and a little cash as backups."
  - question: "Can I use Apple Pay on the subway in China?"
    answer: "In some cities including Shanghai, Beijing, Guangzhou, and Shenzhen the metro gates accept contactless foreign cards, so an eligible card in Apple Pay can tap through, but coverage varies by city and line, so carry a backup."
  - question: "Do I still need cash if I have Apple Pay in China?"
