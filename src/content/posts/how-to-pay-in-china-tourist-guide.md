...
faqs:
  - question: "Can I use my Visa or Mastercard directly in China?"
    answer: "In major cities, more hotels, department stores, and airports now accept foreign Visa and Mastercard than ever before. However, most everyday merchants — small restaurants, street vendors, convenience stores, and transport — are mobile-first and may not take physical foreign cards. The reliable approach is to link your card to Alipay or WeChat Pay."
  - question: "Do I still need cash in China?"
    answer: "You can travel almost entirely cashless, but carrying a small amount of RMB (a few hundred yuan) is wise for rare situations like a vendor whose QR reader is down, or a machine that only takes cash. By law, merchants in China must accept cash, though in practice some are unprepared to."
  - question: "Is it better to use Alipay or WeChat Pay?"
    answer: "Both work almost everywhere and both let foreign visitors link international cards. Alipay tends to have a slightly smoother onboarding flow for tourists and a built-in translation and mini-program ecosystem, while WeChat Pay is convenient if you already use WeChat to message people in China. Setting up both takes little extra effort and gives you a fallback."
  - question: "Are there fees when paying with a foreign card via Alipay or WeChat Pay?"
    answer: "For transactions above a certain threshold (historically around 200 RMB), a small processing fee of roughly 3% may apply. Smaller transactions are often fee-free. Your card issuer may also apply foreign transaction fees, so a card with no FX fees is ideal."
  - question: "Can I get money back if a mobile payment goes wrong?"
    answer: "Yes. Both Alipay and WeChat Pay keep a transaction history in the app, and you can request refunds from merchants directly through the order record. Disputes are easier to resolve than with cash, which is one more reason mobile payment is the safer default."
  - question: "Do I need a Chinese bank account or phone number to pay?"
    answer: "No Chinese bank account is required — you link your foreign card instead. You do need a working mobile number to receive the verification code during setup, but your home number works for this. A local eSIM or roaming plan is enough to complete registration."
---
