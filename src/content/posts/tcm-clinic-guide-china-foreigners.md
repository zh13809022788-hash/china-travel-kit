...
faqs:
  - question: "Can foreigners visit a TCM doctor in China?"
    answer: "Yes. Foreigners can walk into most public hospital TCM departments and book an appointment. You will need your passport for registration. Some top-tier hospitals have international clinics with English-speaking staff, but most regular TCM departments are Chinese-only, so prepare translation tools."
  - question: "How much does a TCM consultation cost in 2026?"
    answer: "A regular TCM consultation at a public hospital costs 50-200 RMB (7-28 USD). Herbal medicine adds 100-400 RMB per week. International clinics or private TCM centers charge 500-1500 RMB per session. Acupuncture and tuina sessions range from 100-500 RMB depending on the facility."
  - question: "Can I use travel insurance for TCM treatment?"
    answer: "Many international travel insurance policies cover TCM treatment at public hospitals. Check with your provider before your trip. You will need to keep all receipts and the doctor's prescription note. Private clinics are less likely to be covered."
  - question: "Do TCM doctors speak English?"
    answer: "At regular public hospital TCM departments, English is rarely spoken. International clinics at large hospitals like Peking Union or Huashan have English-speaking staff but charge higher fees. For regular clinics, prepare a translation app and our symptom phrase card."
  - question: "Is it safe for short-term tourists to try TCM?"
    answer: "Yes, for non-invasive treatments like herbal medicine or tuina massage. Acupuncture and cupping are also generally safe at licensed public hospitals. Avoid unlicensed street clinics. Always choose a public hospital or a well-reviewed established clinic."
  - question: "How do I find a TCM clinic near me in China?"
    answer: "Use the hospital appointment mini-programs inside Alipay or WeChat, or search on Dianping for user ratings. For public hospitals, search for '中医科' (zhong yi ke) inside a major hospital. Top hospitals with TCM departments include Guanganmen Hospital in Beijing and Yueyang Hospital in Shanghai."
  - question: "Can I buy Chinese herbal medicine without a prescription?"
    answer: "Some prepared herbal remedies are available over the counter at pharmacy chains like Dashenlin (大参林) or Laobaixing (老百姓). However, for customized herbal formulas, you need a prescription from a licensed TCM doctor. Be cautious with self-prescribing."
  - question: "How long does a TCM treatment session take?"
    answer: "A first consultation typically takes 20-40 minutes including pulse and tongue diagnosis. Acupuncture sessions last 20-30 minutes. Cupping or tuina massage sessions are 15-30 minutes. Herbal medicine consultations are shorter, around 10-15 minutes after the initial diagnosis."
  - question: "What is pulse and tongue diagnosis?"
    answer: "TCM doctors diagnose by feeling your pulse on both wrists (cun-guan-chi positions) and examining your tongue's color, coating, and shape. These are standard diagnostic methods. Both are painless and non-invasive. The doctor may also ask about your sleep, digestion, and energy levels."
  - question: "Can TCM help with jet lag or travel fatigue?"
    answer: "Many travelers visit TCM clinics for jet lag, digestive issues, and general fatigue from long-haul travel. Acupuncture and customized herbal formulas are commonly used. Some hotels in China can recommend nearby TCM clinics or offer basic tuina massage on-site."
  - question: "What payment methods do TCM clinics accept?"
...
1. **Google Translate** — Download the Chinese (Simplified) offline pack. The camera translation feature works well for reading medicine labels and prescription notes.
2. **Pleco** — A highly accurate Chinese-English dictionary app with medical term support. The free version is adequate.
3. **Save our symptom phrase card** — Print or screenshot the list below.
...
**How to find them:** Open Alipay or WeChat → search for the hospital mini-program → browse the department list for "中医科" (zhōng yi kē).
...
**Online (recommended):**
1. Open Alipay or WeChat → search the hospital name → open its mini-program
2. Select "挂号" (registration) → choose department "中医科"
3. Pick a doctor and time slot → enter your passport number (some allow text input)
4. Pay the registration fee via Alipay or WeChat Pay
5. You will receive a QR code — save the screenshot

**Walk-in:**
If online booking is not possible, go to the hospital's registration counter. Show this message to the staff: "我想挂中医科的号" (wǒ xiǎng guà zhōng yī kē de hào). Have your passport ready.

### Step 3: The Consultation

1. **Check in** — Go to the TCM department floor, find the check-in machine or counter. Scan your QR code or show your registration receipt.
2. **Wait** — Wait times vary from 10 minutes to 2 hours depending on the doctor's popularity.
3. **Diagnosis** — The doctor will take your pulse (on both wrists), examine your tongue, ask about your symptoms, sleep, digestion, and energy levels.
4. **Prescription** — If herbal medicine is prescribed, the doctor will write a formula (处方). This is typically 5-14 days of herbs.
...
1. **Pay the fee** — Take the prescription to the payment counter. Alipay or WeChat Pay is preferred. Keep all receipts for insurance claims.
2. **Collect medicine** — Go to the hospital pharmacy (药房). You may need to wait 15-60 minutes while herbs are prepared.
3. **Herbal forms:** You can choose between raw herbs (need to boil at home), granular granules (dissolve in hot water), or prepared pills. Granules are the most convenient for travelers.
4. **Some hospitals offer decoction service** — they boil the herbs for you and package them into single-dose sachets that you can drink on the go.
...
- **Inform the doctor of allergies** — Tell the doctor about any medication allergies. Show this: "我对...过敏" (wǒ duì ... guò mǐn) and have your allergies written in Chinese.
...
- **Keep receipts** — Needed for insurance claims. Ask for an invoice (发票, fā piào) at the payment counter.
...
5. **Book a public hospital near your accommodation** using Alipay or WeChat mini-programs.
