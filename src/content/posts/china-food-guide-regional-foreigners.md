...
faqs:
  - question: "How spicy is real Sichuan food?"
    answer: "Authentic Sichuan food is known for its mala (numbing and spicy) flavor profile. Dishes use Sichuan peppercorns and dried chilies. Start with mild dishes like dan dan noodles (ordered 'bu la' — not spicy) and work your way up. Many restaurants in tourist areas offer adjustable spice levels."
  - question: "Can I find Western food in China?"
    answer: "Yes. Major cities have Western restaurants, fast food chains (McDonald's, KFC, Pizza Hut), and international hotels with buffet breakfasts. Smaller cities have fewer options. Download Meituan or Dianping to search for '西餐' (Western food) near your location."
  - question: "Is street food safe for foreigners?"
    answer: "Street food is generally safe if you choose busy stalls with high turnover — the food is cooked fresh and hot. Look for stalls where locals queue. Avoid food that has been sitting out at room temperature. Bottled water is always recommended."
  - question: "How do I order food delivery in China without speaking Chinese?"
    answer: "Use Meituan or Ele.me with the auto-translate feature inside the app. Alternatively, use the H5 web versions (waimai.meituan.com or ele.me) in your browser. Alipay also has food delivery mini-programs. Our food delivery guide has step-by-step instructions."
  - question: "How do I tell a restaurant I don't want something?"
    answer: "Use these phrases: 'bu yao la' (no spicy), 'shao fang yan' (less salt), 'bu yao xiang cai' (no cilantro), 'wu hua sheng' (no peanuts). Show the phrase to your server or use a translation app. Many menu apps have dietary preference filters."
  - question: "What is the tipping etiquette in Chinese restaurants?"
    answer: "Tipping is not customary in China. Do not tip at regular restaurants, noodle shops, or street stalls. Some high-end hotels and international restaurants include a service charge; check your bill. For more details, read our tipping guide."
  - question: "What are some vegetarian-friendly Chinese dishes?"
    answer: "Mapo tofu (without minced meat), eggplant with garlic sauce, stir-fried greens, cucumber salad, and steamed buns. Always clarify you're vegetarian — show 'wo chi su' (I am vegetarian) or use Dianping to search for '素食' (vegetarian) restaurants."
  - question: "How much does a meal cost in China in 2026?"
    answer: "Street food and noodle shops: 10-30 RMB per person. Casual restaurants: 50-120 RMB. Mid-range dining: 150-300 RMB. High-end restaurants: 400+ RMB per person. Mobile payment (Alipay/WeChat Pay) is accepted almost everywhere."
  - question: "Can I use food delivery apps without a Chinese phone number?"
...
| Cuisine | English Name | Flavor Profile | Must-Try Dish | Spice Level |
|---------|-------------|----------------|---------------|-------------|
| 川菜 | Sichuan | Numbing and spicy (mala) | Mapo tofu (麻婆豆腐), Kung Pao chicken | Very spicy |
| 粤菜 | Cantonese | Light, fresh, steamed | Dim sum (点心), roast goose | Mild |
| 鲁菜 | Shandong | Salty, fresh, hearty | Braised sea cucumber, sweet and sour carp | Mild |
| 苏菜 | Jiangsu | Sweet, delicate, refined | Sweet and spare ribs, xiaolongbao | Mild |
| 闽菜 | Fujian | Seafood, sweet, umami | Buddha jumping over the wall (佛跳墙) | Mild |
| 浙菜 | Zhejiang | Fresh, light, slightly sweet | Dongpo pork (东坡肉), West Lake fish | Mild |
| 湘菜 | Hunan | Spicy, sour, bold | Chairman Mao's red braised pork, spicy chicken | Spicy |
| 徽菜 | Anhui | Wild herbs, mountain ingredients | Stewed soft-shell turtle, bamboo shoots | Mild |
...
|---------|---------|--------|
| I want to order | 我要点菜 | wǒ yào diǎn cài |
| Not spicy, please | 不要辣 | bù yào là |
| Less spicy | 微辣 | wēi là |
| No cilantro, please | 不要香菜 | bù yào xiāng cài |
| No peanuts | 不要花生 | bù yào huā shēng |
| Less oil, please | 少油 | shǎo yóu |
| I am vegetarian | 我吃素 | wǒ chī sù |
| I am allergic to... | 我对...过敏 | wǒ duì...guò mǐn |
| How much? | 多少钱？ | duō shǎo qián? |
| Pack it to go | 打包 | dǎ bāo |
...
- **Tipping** — Do not tip. It is not expected and may cause confusion. Our [tipping guide](/posts/tipping-in-china-when-it-s-expected-and-when-it-s-not/) explains in detail.
...
| Option | Best For | Price Range | Language Barrier | Safety |
|--------|----------|-------------|-----------------|--------|
| **Street food** | Quick snacks, breakfast, night markets | 5-30 RMB | Low (point and pay) | Medium — choose busy stalls |
| **Casual restaurant** | Lunch, dinner with friends | 40-120 RMB | Low-medium (QR menu) | High |
| **Food delivery** | Hotel meals, late night, bad weather | 20-80 RMB | Medium (app needed) | High |
| **Night market** | Variety, local experience | 10-50 RMB per item | Low (point and pay) | Medium — go for popular items |
| **High-end restaurant** | Special occasion, business | 200+ RMB | Low (English menus common) | Very high |
...
| Meal Type | Street Food | Casual Restaurant | Mid-Range |
|-----------|------------|-------------------|-----------|
| Breakfast | 5-15 RMB | 15-30 RMB | 40-80 RMB |
| Lunch | 10-25 RMB | 30-60 RMB | 80-150 RMB |
| Dinner | 15-40 RMB | 50-120 RMB | 150-300 RMB |
