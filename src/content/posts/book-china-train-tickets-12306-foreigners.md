...
faqs:
  - question: "Do I need a Chinese ID or bank account to book on 12306?"
    answer: "No. The official 12306 international service lets you register and book with your passport, and it now accepts major foreign Visa and Mastercard credit cards, as well as Alipay and WeChat Pay linked to a foreign card. You do not need a Chinese national ID or a local bank account."
  - question: "Is the 12306 app available in English?"
    answer: "Yes. There is an official English-language international version of the 12306 app and website (operated by China Railway) designed for overseas passengers. It supports passport registration, English station names, and foreign payment methods. Make sure you download the genuine official app and not a lookalike."
  - question: "How far in advance can I book China train tickets?"
    answer: "As of 2026, tickets typically go on sale up to 15 days before departure. Popular high-speed routes and travel during holidays such as Spring Festival, the May and October public holidays sell out quickly, so book as early as the window opens."
  - question: "Do I need to print my ticket or collect it from a machine?"
    answer: "For most high-speed and regular trains, China uses paperless e-tickets tied to your passport. You simply scan your passport at the gate to enter and board. You only need to collect a paper ticket if you require it for reimbursement, and that is done at a staffed window, not the self-service machines, because those generally read Chinese ID cards only."
  - question: "What happens if my passport does not scan at the station gate?"
    answer: "Foreign passports sometimes do not read at the automatic e-gates. This is normal. Go to the manual lane or staffed gate beside the automatic gates, show your passport and your booking confirmation, and staff will verify you manually and let you through. Arriving early gives you time for this."
  - question: "Can I get a refund or change my train ticket?"
    answer: "Yes. You can refund or change tickets through the same 12306 app before departure, subject to a tiered fee that increases the closer you are to departure time. Refunds go back to your original payment method. Changing to a different train depends on seat availability on the new service."
  - question: "Are third-party booking sites safe to use?"
    answer: "Reputable platforms like Trip.com and China Highlights are widely used by foreign travelers and are generally safe. They add a small service fee per ticket in exchange for an easier English interface and support, but they still issue the same official China Railway ticket linked to your passport."
---
