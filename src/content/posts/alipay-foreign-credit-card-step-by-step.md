...
faqs:
  - question: "What is the Alipay TourPass and do I still need it in 2026?"
    answer: "TourPass was a prepaid, top-up mini-program that foreign visitors used before Alipay allowed direct card binding. Since 2023, Alipay has let international travelers link a foreign Visa or Mastercard directly to the main app, so most tourists no longer need TourPass at all. Direct card linking is now the standard, simpler route, and it is the method this guide focuses on."
  - question: "Which foreign cards can I link to Alipay?"
    answer: "Alipay supports major international networks including Visa, Mastercard, JCB, Diners Club, and Discover. Credit cards generally work more reliably than debit cards. The card must allow international online transactions, so if you have travel notifications or online-purchase blocks on your account, clear those with your bank before you try to link."
  - question: "Do I need a Chinese phone number or bank account to use Alipay?"
    answer: "No. You can register with your home country mobile number and receive the verification code on it. You link your foreign card instead of a Chinese bank account. You only need working mobile data or Wi-Fi to complete registration and identity verification."
  - question: "Are there fees when paying with a foreign card through Alipay?"
    answer: "Transactions of 200 RMB or less are typically free of Alipay's service fee. For payments above 200 RMB, Alipay applies a service fee of about 3%. Separately, your own card issuer may charge a foreign transaction fee, so a no-FX-fee card saves the most money."
  - question: "Why does my payment or card linking keep getting declined?"
    answer: "The most common causes are a bank that blocks international or online transactions, a name mismatch between your passport and card, an incomplete facial verification, or hitting a transaction limit. Contact your bank to authorize international use, make sure your details match exactly, and split large payments if you exceed a per-transaction cap."
  - question: "How long does the whole Alipay setup take?"
    answer: "For most people it takes about ten to fifteen minutes, assuming your card and passport are on hand and your bank does not block the transaction. Doing it before you fly, on stable internet, avoids the stress of troubleshooting after you land."
---
