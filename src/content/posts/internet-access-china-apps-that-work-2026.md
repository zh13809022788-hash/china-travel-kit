...
faqs:
  - question: "Which apps are blocked in China in 2026?"
    answer: "China's network filtering still blocks most major Western services, including Google Search, Gmail, Google Maps, YouTube, WhatsApp, Instagram, Facebook, X (formerly Twitter), Signal, Telegram, and many Western news sites. Some services outside this list work fine, and the situation can shift, so it's wise to set up your connection so these apps keep working rather than assuming any single one is reachable."
  - question: "Which apps and services do work normally in China?"
    answer: "Local Chinese apps work perfectly, including WeChat, Alipay, Baidu Maps, Amap, and DiDi. Apple services and Microsoft services typically function, and email through standard IMAP often works. If you rely on Google Maps or WhatsApp, though, you'll want a connection method that routes around the filtering, such as a travel eSIM or international roaming."
  - question: "How do travel eSIMs let me use blocked apps in China?"
    answer: "Many travel eSIMs marketed for China roam on a partner network and route your data out through a location outside mainland China. Because your traffic exits outside the domestic filtering system, apps like Google, WhatsApp, and Instagram generally work without any extra software. Always confirm this in the product description, since a minority of plans connect to a local network and apply the same restrictions as a domestic SIM."
  - question: "Does international roaming bypass China's internet restrictions?"
    answer: "Usually yes. When you roam on your home carrier's plan, your data typically routes through your home network rather than the domestic Chinese system, so your normal apps keep working. The downside is cost, as roaming can be expensive. A travel eSIM often gives you the same unrestricted access at a much lower price, which is why many visitors choose one."
  - question: "Should I download a VPN before arriving in China?"
    answer: "If you plan to use a local Chinese SIM card, you would need a reputable VPN installed before arrival, because VPN provider apps and websites are difficult to reach once you're inside China. However, if you use a travel eSIM or roaming that already routes around the filtering, you typically won't need a VPN at all. Set up whichever approach you choose before you land."
  - question: "Will my hotel Wi-Fi in China let me access Google and WhatsApp?"
    answer: "Usually not. Hotel and public Wi-Fi in China runs through the same domestic network filtering, so blocked apps generally remain blocked on those connections. This is why your own connection method matters. A travel eSIM or roaming line gives you consistent access that doesn't depend on whatever local Wi-Fi you happen to connect to."
---
