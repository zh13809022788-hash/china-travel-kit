...
faqs:
  - question: "Is an eSIM or pocket WiFi better for China?"
    answer: "For a solo traveler or a couple who both have eSIM-capable phones, a travel eSIM is usually better: there's no device to carry or charge, no rental to return, and many China eSIMs route data so your normal apps work. Pocket WiFi makes more sense for a group or family sharing one connection across several devices, or for travelers whose phones don't support eSIM."
  - question: "Should I buy a local Chinese SIM card as a tourist?"
    answer: "A local SIM from China Mobile or China Unicom is cheap and reliable for domestic use, but it connects through the mainland network, so blocked apps like Google and WhatsApp won't work unless you installed a reputable VPN before arrival. For most short-term visitors who want their normal apps, a travel eSIM that routes internationally is simpler and avoids the VPN requirement."
  - question: "Does my phone need to support eSIM to use one in China?"
    answer: "Yes. Your phone must have eSIM hardware and be carrier-unlocked. Most iPhones from the XS onward, recent Google Pixel, and flagship Samsung Galaxy models support eSIM, though some phones sold within mainland China have the feature disabled. If your phone doesn't support eSIM, pocket WiFi or a local SIM is your alternative."
  - question: "How much does each option cost for a week in China?"
    answer: "Prices vary, but as a rough guide, a travel eSIM for a week typically costs less than roaming and is competitive with other options, with no deposit. Pocket WiFi rental adds a daily rental fee plus a deposit and pickup or return logistics. A local SIM is cheap for the SIM itself but requires buying in person with your passport and may need a VPN for blocked apps. Compare current plans before choosing."
  - question: "Can I share a travel eSIM connection with others?"
    answer: "Many travel eSIMs allow hotspot tethering, so you can share your connection with a companion's device, though this uses your data faster and can drain your battery. If several people need to be online at once throughout the day, a pocket WiFi device designed for sharing, or separate eSIMs, is usually more practical than tethering from one phone."
  - question: "What happens to my connection if I visit multiple cities in China?"
    answer: "A travel eSIM, pocket WiFi, and local SIM all work across cities as long as the underlying network has coverage there, which the major networks generally do for cities and intercity routes. For remote areas, check the coverage of your chosen network. You don't need to change anything when traveling between major cities on any of these options."
---
...
1. **Solo traveler or couple with eSIM phones who want normal apps working:** a travel eSIM with unrestricted routing is usually the best fit. Simplest setup, no device to manage, apps work out of the box.

2. **Family or group needing several devices online at once:** pocket WiFi can be more economical and practical, since one device serves everyone. Confirm its app handling if that matters.

3. **Phone doesn't support eSIM:** choose pocket WiFi for sharing and convenience, or a local SIM if you're budget-focused and either don't need blocked apps or have set up a VPN in advance.
