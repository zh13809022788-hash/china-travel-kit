...
faqs:
  - question: "Can foreigners book China high-speed rail tickets online?"
    answer: "Yes. The official Railway 12306 app now has an English-language version that supports foreign passport registration and direct booking. You can also book through Trip.com, which many travelers find easier to use, usually for a small markup. Both let you pay with a foreign card or a mobile wallet, so you can secure tickets before you even arrive in China."
  - question: "Do I need a paper ticket, or can I use my passport?"
    answer: "For high-speed rail, tickets are paperless e-tickets, and at most major stations you simply scan your passport at the gate to enter and board. There's no need to collect a paper ticket first. Bring the exact passport you used to book, since the name and document must match. You can still request a paper receipt at a station window if you need one for reimbursement."
  - question: "What are the seat classes on China's high-speed trains?"
    answer: "The main classes are Second Class, First Class, and Business Class. Second Class has a 2 plus 3 seat layout and is the cheapest and most common. First Class offers a 2 plus 2 layout with more legroom. Business Class has spacious 2 plus 1 seats that often recline nearly flat, at the highest price. Some trains also offer premier or VIP options. Second Class is perfectly comfortable for most journeys."
  - question: "How early should I book China train tickets?"
    answer: "Popular routes and travel around Chinese holidays can sell out, so booking several days to a couple of weeks ahead is wise for busy corridors like Beijing to Shanghai. For less popular routes or off-peak times, you can often book closer to departure. Booking early also gives you a better choice of seat class and departure time."
  - question: "How early should I arrive at the station for a high-speed train?"
    answer: "Arrive at least 30 to 60 minutes before departure. Chinese high-speed rail stations are large and involve security screening and passport checks at the gate, and boarding typically closes a few minutes before the train leaves. For big stations or during busy periods, lean toward the full hour to avoid stress. Gates usually open around 15 to 20 minutes before departure."
  - question: "Can I use my passport to board if I booked through Trip.com?"
    answer: "Yes. Regardless of whether you booked through the 12306 app or Trip.com, your booking is tied to your passport, and you scan that passport at the station gate to board. Make sure the passport details you entered when booking exactly match your actual passport, since a mismatch can prevent you from boarding."
---
