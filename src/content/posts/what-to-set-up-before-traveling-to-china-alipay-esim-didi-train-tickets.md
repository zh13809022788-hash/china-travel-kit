...
faqs:
  - question: "What apps should I install before traveling to China?"
    answer: "Install Alipay, WeChat, a translation app, your eSIM or carrier app, your hotel and airline apps, and a ride-hailing option such as DiDi if available in your app store."
  - question: "Can I set up Alipay before arriving in China?"
    answer: "Yes. You should download Alipay, register, add your foreign card, and complete any required verification before departure so you are not troubleshooting payment at the airport."
  - question: "Should I buy China train tickets before arriving?"
    answer: "Book ahead for busy routes, weekends, holidays, and fixed intercity moves. For flexible short trips, you may be able to book later, but first-time visitors should avoid last-minute train planning."
  - question: "Do I need DiDi in China?"
...
| Setup item | Do before departure | Why it matters |
|---|---|---|
| Alipay | Install, register, add card, verify identity if requested | Most daily payments are QR-based |
| WeChat / WeChat Pay | Install, register, add card if possible | Messaging, payments, mini-programs, local contacts |
| eSIM or roaming | Buy, install, save instructions | Phone data is the foundation for everything else |
| DiDi or ride-hailing | Install and test login | Useful for airports, luggage, late nights, rain |
| Train tickets | Create booking plan or account | Popular routes can sell out or become inconvenient |
| Translation | Download offline language pack | Helps with menus, signs, taxi notes, and app screens |
| Chinese addresses | Save hotel and key destinations in Chinese | Drivers and local staff may need Chinese text |
| Cash backup | Prepare or plan ATM withdrawal | Rare fallback when mobile payment fails |
...
Detailed guide: [Alipay Foreign Credit Card Step by Step](/posts/alipay-foreign-credit-card-step-by-step/).
...
Related guide: [WeChat Pay Foreign Visitors Guide](/posts/wechat-pay-foreign-visitors-guide/).
...
If the app setup is difficult, use the [Show to Driver tool](/tools/show-to-driver/) to create large Chinese text for taxi drivers or hotel staff.

Related guide: [DiDi China Guide for Foreign Tourists](/posts/didi-china-foreign-tourists-guide/).
...
Related guide: [How Much Cash Should You Bring to China?](/posts/how-much-cash-to-bring-to-china/).
