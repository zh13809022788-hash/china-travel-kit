...
faqs:
  - question: "Can I use my foreign Visa or Mastercard directly at shops in China?"
    answer: "Sometimes, but not reliably. After a 2024 to 2025 push to improve foreign card acceptance, international Visa, Mastercard, and Amex now work at most international hotels, airports, large department stores, and chain retailers. However, small restaurants, local shops, markets, and street vendors still largely expect mobile payment or cash, and many will not have a terminal that accepts foreign cards at all. Treat your physical card as a backup rather than your main payment method."
  - question: "Which ATMs in China accept foreign cards?"
    answer: "Bank of China and ICBC are the most foreign-card-friendly, and their ATMs generally accept Visa, Mastercard, Plus, and Cirrus network cards. Look for your card network's logo on the machine. When the ATM offers to charge you in your home currency, always decline and choose to be charged in Chinese yuan, because the machine's own conversion rate is usually worse than your bank's."
  - question: "How much can I withdraw from a Chinese ATM with a foreign card?"
    answer: "Per-transaction limits are commonly around 2,500 to 3,000 RMB at Bank of China and ICBC machines, though the daily limit is higher, often around 10,000 RMB, so you can make several withdrawals. Because your home bank may charge a flat fee plus a foreign exchange fee on each withdrawal, it is usually cheaper to withdraw the maximum per transaction rather than several small amounts."
  - question: "Will I be charged fees for using my foreign card in China?"
    answer: "Likely yes. Expect a foreign transaction fee of roughly 1 to 3 percent from your card issuer on purchases, plus possible ATM withdrawal fees. A card that advertises no foreign transaction fees will save you money over a trip. Always pay or withdraw in Chinese yuan rather than your home currency to avoid an extra dynamic currency conversion markup."
  - question: "Should I tell my bank before traveling to China?"
    answer: "Yes. Notify your card issuer of your travel dates and destination so a payment from China does not get flagged as fraud and frozen. A frozen card in a country where foreign cards already have limited acceptance is a serious headache, so set a travel notice through your banking app or by phone before you leave."
  - question: "Is it better to use a physical card or a mobile wallet in China?"
    answer: "For day-to-day spending, linking your foreign card to Alipay or WeChat Pay is far more useful than the physical card itself, because mobile payment is accepted almost everywhere while card terminals are not. Keep the physical card for hotels, ATMs, and larger establishments, and rely on the linked mobile wallet for everything else."
---
...
[Check which payment method fits your trip](https://example.com/affiliate?tag=AFF_PAYMENT)
