...
faqs:
  - question: "Can I use WeChat Pay in China with a foreign credit card?"
    answer: "Yes. Since late 2023, WeChat Pay accepts international Visa, Mastercard, JCB, Discover, and Diners Club cards. You link the card inside the app's Wallet section, complete a one-time identity check with your passport, and you can then pay at almost any merchant that shows a WeChat Pay QR code."
  - question: "Do I need a Chinese bank account or phone number to use WeChat Pay?"
    answer: "You do not need a Chinese bank account. You do need a working mobile number to receive the registration verification code, but a number from your home country works fine. A foreign passport is required for the identity verification step when you link an international card."
  - question: "Are there fees for foreign cards on WeChat Pay?"
    answer: "Individual payments of 200 RMB or less are free. For any single transaction above 200 RMB, WeChat charges a 3% fee on top of the amount. Your own card issuer may also apply foreign transaction fees and currency conversion charges, so check your card's terms."
  - question: "What are the spending limits for foreign visitors on WeChat Pay?"
    answer: "Foreign-card users face a single-transaction cap of 6,500 USD, a monthly cap of 10,000 USD, and an annual cap of 50,000 USD (values are set in USD equivalent). Before completing passport verification, small unverified accounts have much lower limits, typically a few hundred RMB per transaction."
  - question: "Why does my foreign card keep getting rejected on WeChat Pay?"
    answer: "The most common causes are a card type that is not supported, your bank blocking an unfamiliar overseas charge, exceeding a transaction limit, or the merchant being a personal peer-to-peer account rather than a registered business. Contact your bank to whitelist WeChat, and try a merchant that accepts card-linked payments."
  - question: "What is the difference between WeChat and WeChat Pay?"
    answer: "WeChat is the messaging and social app; WeChat Pay is the payment feature built into it. There is no separate app to download. Once you have WeChat installed and an account created, WeChat Pay lives inside the Me tab under Services or Wallet."
---
