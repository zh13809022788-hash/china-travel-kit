...
faqs:
  - question: "Can I use a foreign credit card on the Shanghai Metro?"
    answer: "You cannot tap a foreign credit card at the gate directly, but you can link most Visa and Mastercard credit cards inside the Alipay or WeChat app and then ride using the app's transit QR code, which is the easiest option for short-term visitors."
  - question: "How much does a Shanghai Metro ride cost?"
    answer: "Fares are distance-based and start at 3 yuan for trips up to 6 kilometers, rising in 1-yuan increments as you travel farther, so most trips across the city cost between 3 and 9 yuan."
  - question: "Do I need to exit and re-enter the station to transfer lines?"
    answer: "No, transfers between lines happen inside the paid area at interchange stations, so you simply follow the colored line signs to the next platform without tapping out or paying again."
  - question: "What are the Shanghai Metro operating hours?"
    answer: "Most lines run from roughly 5:30 AM to around 10:30 or 11:00 PM, though exact first and last train times vary by line and station, and a few central lines run slightly later on weekends."
  - question: "Is there English on the Shanghai Metro?"
